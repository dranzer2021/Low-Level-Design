...
public:
    ...
    void initializeRestaurants() {
        ...
        Restaurant* restaurant2 = new Restaurant("Udupiwala", "Delhi");
        restaurant1->addMenuItem(MenuItem("P1", "Dosa", 120));
        restaurant1->addMenuItem(MenuItem("P2", "Vada", 15));

        Restaurant* restaurant3 = new Restaurant("Haldiram", "Kolkata");
        ...
        Restaurant* restaurant4 = new Restaurant("Saravana Bhavan", "Chennai");
